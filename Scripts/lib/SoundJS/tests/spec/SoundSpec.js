describe("SoundJS", function () {
	...
	it("should play mp3s", function (done) {
		var _this = this;
		this.sound.registerSound(this.mp3File, "Crash");
		this.sound.on("fileload", function (evt) {
			expect(evt.src).toBe(_this.mp3File);
			var s = createjs.Sound.play("Crash");
	...
	it("should play oggs", function (done) {
		var _this = this;
		this.sound.registerSound(this.oggFile, "Crash");
		this.sound.on("fileload", function (evt) {
	...
	it("removeSound() should work", function (done) {
		this.sound.registerSound(this.mp3File, "Crash");
		this.sound.on("fileload", function (evt) {
			createjs.Sound.removeSound("Crash");
			var s = createjs.Sound.play("Crash");
	...
	it("loadComplete() should be true", function (done) {
		this.sound.registerSound(this.mp3File, "Crash");
		this.sound.on("fileload", function (evt) {
			expect(createjs.Sound.loadComplete("Crash")).toBe(true);
			createjs.Sound.removeAllSounds();
			expect(createjs.Sound.loadComplete("Crash")).toBe(false);
			done();
		});
	});
